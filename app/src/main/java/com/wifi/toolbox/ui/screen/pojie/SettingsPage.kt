        ...
        LazyColumn(
            ...
            item {
                ListPreference(
                    ...
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(readLogMode = newValue)) },
                    title = { Text("读取网络日志") },
            ...
            item {
                ListPreference(
                    ...
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(connectMode = newValue)) },
                    title = { Text("连接wifi") },
            ...
            item {
                ListPreference(
                    ...
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(manageSavedMode = newValue)) },
            ...
            item {
                ListPreference(
                    ...
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(enableMode = newValue)) },
                    title = { Text("开关wifi") },
            ...
            item {
                AnimatedVisibility(
                    ...
                    ListPreference(
                        ...
                        onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(commandMethod = newValue)) },
                        title = { Text("命令行实现方式") },
            ...
            item {
                FooterPreference(summary = { Text("注：实现方法越往前越推荐，如果不能使用请尝试更换不同的组合") })
            }
            ...
            item {
                SwitchPreference(
                    ...
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(screenAlwaysOn = newValue)) },
                    title = { Text("屏幕常亮") },
            ...
            item {
                SwitchPreference(
                    value = pojieSettings.showRunningNotification,
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(showRunningNotification = newValue)) },
                    title = { Text("显示通知") },
            ...
            item {
                SwitchPreference(
                    ...
                    onValueChange = { newValue -> onPojieSettingsChange(pojieSettings.copy(exitToPictureInPicture = newValue)) },
                    title = { Text("自动进入小窗") },
